...
public class CompletePreqs {
    ...
    private final HashMap<String, List<String>> modulesWithPreqs;
    private final ArrayList<String> addToModulesCompleted;

    // To track modules that are already unlocked
    private final Set<String> unlockedModulesSet;
